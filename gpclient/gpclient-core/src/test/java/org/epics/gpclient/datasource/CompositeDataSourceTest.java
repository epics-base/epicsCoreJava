...
import org.epics.gpclient.datasource.CompositeDataSourceConfiguration;
...
//        builder.addChannel("pv01", new LatestValueCollector<>(Double.class));
//        builder.addChannel("pv03", new LatestValueCollector<Double>(Double.class));
//        ReadRecipe recipe = builder.build();
//
//        // Call and check
//        composite.connectRead(recipe);
//        mock1.getReadRecipe().getChannelReadRecipes().equals(recipe.getChannelReadRecipes());
...
//        // Call only default
//        ReadRecipeBuilder builder = new ReadRecipeBuilder();
//        builder.addChannel("pv01", new LatestValueCollector<Double>(Double.class));
//        builder.addChannel("pv03", new LatestValueCollector<Double>(Double.class));
//        builder.addChannel("mock1://pv02", new LatestValueCollector<Double>(Double.class));
...
//
//        ReadRecipeBuilder builder = new ReadRecipeBuilder();
//        builder.addChannel("mock://pv03", new LatestValueCollector<Double>(Double.class));
//        ReadRecipe recipe = builder.build();
//
//        // Should cause error
//        composite.connectRead(recipe);
...
//        builder.addChannel("mock://pv03", new WriteCollector<>());
