 ...
 *
 */
public class StructureArrayTest extends TestCase {
    /**
     * test DBListener.
     */
    public static void testStructureScalar() {
    	PVDatabase master = PVDatabaseFactory.getMaster();
    	Requester iocRequester = new RequesterForTesting("structureArray");
        XMLToPVDatabaseFactory.convert(master,
                "src/org/epics/pvData/test/structureArrayTest.xml",iocRequester);
