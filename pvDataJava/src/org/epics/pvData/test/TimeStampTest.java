...
public class TimeStampTest extends TestCase {
	...
	public void testConversion()
	{
		...
		TimeStamp t1 = TimeStampFactory.create(now);
		TimeStamp t2 = TimeStampFactory.create(t1.getSecondsPastEpoch(), t1.getNanoSeconds());
		
		assertEquals(now, t1.getMilliSeconds());
