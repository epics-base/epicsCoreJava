...
public interface Channel extends Requester{
    ...
    /*
    void createChannelGetArray(ChannelGetArrayRequester requester,String subField, int localCapacity);
    
    public interface ChannelGetArrayRequester extends Requester {
        void channelGetArrayConnect(ChannelGetArray channelGetArray,PVArray array);
        void getDone(boolean success);
    }

    public interface ChannelGetArray extends ChannelRequest {
    	boolean changed();
        void getArray(boolean lastRequest, int offset, int count, int toOffset);
    }
    */
