...
public class ChannelMonitorImpl extends BaseRequestImpl implements Monitor {
	...
	/* (non-Javadoc)
	 * @see org.epics.ca.client.impl.remote.channelAccess.BaseRequestImpl#destroyResponse(org.epics.ca.core.Transport, byte, java.nio.ByteBuffer, byte qos, org.epics.pvData.pv.Status)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.epics.ca.client.ChannelMonitor#start()
	 */
	@Override
	public Status start() {
		if (destroyed)
	...
	/* (non-Javadoc)
	 * @see org.epics.ca.client.ChannelMonitor#stop()
	 */
	@Override
	public Status stop() {
		if (destroyed)
