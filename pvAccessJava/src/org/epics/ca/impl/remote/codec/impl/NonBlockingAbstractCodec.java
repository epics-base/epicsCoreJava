...
public abstract class NonBlockingAbstractCodec extends AbstractCodec implements PollEvents {
	...
	/* (non-Javadoc)
	 * @see org.epics.ca.impl.remote.io.PollEvents#registeredNotify(java.nio.channels.SelectionKey, java.lang.Throwable)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.epics.ca.impl.remote.io.PollEvents#pollNotify(java.nio.channels.SelectionKey)
	 */
	@Override
