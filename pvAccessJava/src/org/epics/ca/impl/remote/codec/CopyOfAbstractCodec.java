...
import org.epics.ca.util.Mailbox;
...
public abstract class CopyOfAbstractCodec
	...
	public CopyOfAbstractCodec(ByteBuffer receiveBuffer, ByteBuffer sendBuffer,
	...
	*/
	...
	public void alignBuffer(int alignment) {
		...
		// there is always enought of space
		// since sendBuffer capacity % CA_ALIGNMENT == 0
		sendBuffer.position(newpos);
	}

	/* (non-Javadoc)
	 * @see org.epics.ca.impl.remote.TransportSendControl#startMessage(byte, int)
	 */
	@Override
...
/*
 // low latency
	...
	// TODO think if this is worth it
