...
public abstract class FeatureTestListLong extends FeatureTestListNumber {

    @Override
    abstract public ListLong createConstantCollection();
    
    @Override
    abstract public ListLong createRampCollection();
    ...
    public void equalsLong() {
        assertThat(createRampCollection(), equalTo(new ArrayLong(0L, 1L, 2L, 3L, 4L, 5L, 6L, 7L, 8L, 9L)));
    }
